...
export type Message = AccordionMessage | CarouselMessage | FileDownloadMessage | ImageMessage | SessionDivider | QuickReplyMessage | TextMessage | VideoMessage | RatingMessage;
export {};
