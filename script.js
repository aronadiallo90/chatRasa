...
document.getElementById("close-chat").addEventListener("click", fermerChat);
document.getElementById("open-chat-icon").addEventListener("click", ouvrirChat);
document.getElementById("send-button").addEventListener("click", sendUserMessage);

// Chargement du chat au démarrage
